...
| Accessibility regression | Medium / Critical | Semantic native controls, persistent Pause/Stop, axe per major state, keyboard/narrow/reduced-motion/forced-colors tests, manual screen-reader checklist, no conformance overclaim. | Automated major-state checks green; CI-found 320px overflow fixed; human screen-reader/zoom checklist pending |
